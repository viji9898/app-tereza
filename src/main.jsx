...
const pageMetadata = {
  ...
  baliCreativeGetaway: {
    ...
    description:
      "THE RESET Creative Getaway at Dwa Chandra, Bali. September 23 — September 29, 2026 and October 3 — October 17, 2026.",
    image:
...
function App() {
              ...
              : pathname.startsWith("/offerings")
                ...
                : pathname.startsWith("/corporate")
                  ...
                  : pathname.startsWith("/contracts")
                    ...
                    : pathname.startsWith("/creative-getaway")
  ...
  if (pathname.startsWith("/creative-getaway")) {
