...
const experiences = [
  ...
  [
    "Sound Journey",
    "Live instruments + guided meditation",
    images.facilitating,
    "center",
  ],
  [
    "Breathwork",
    "Energy, focus + nervous-system reset",
    images.hero,
    "center 42%",
  ],
  ...
  [
    "Executive Reset",
    "Private sessions for leadership teams",
    images.portrait,
    "center 30%",
  ],
  [
    "Retreats & Offsites",
    "Bespoke half-day to multi-day programmes",
    images.collage,
    "center",
  ],
];
...
const useCases = [
  ...
  [
    ...
    "Accessible experiences designed for larger organisations.",
  ],
  [
    "Brand & Hospitality Events",
    "Bespoke experiences created around a setting, brand or occasion.",
  ],
];
...
const researchOutcomes = [
  ...
  [
    "72%",
    "lower burnout risk among employees who feel supported by their organisation.",
  ],
  [
    "5×",
    "higher engagement when employees believe their organisation genuinely cares about wellbeing.",
  ],
];
...
const testimonials = [
  [
    ...
    "Cory Obst",
    "Performance Director, Disney On Ice",
  ],
  [
  ...
  return (
    <div className="corp-page">
      <header className="corp-header">
        <a
          className="corp-header__brand"
          href="/"
          aria-label="Tereza Dos Santos home"
        >
          Tereza Dos Santos
        </a>
        ...
        <a className="corp-header__cta" href="#enquire">
          Make an enquiry
        </a>
      </header>
      ...
      <main>
        <section className="corp-hero" aria-labelledby="corp-hero-title">
          <img
            src={images.hero}
            alt="Participants immersed in a guided corporate wellbeing experience"
            fetchPriority="high"
          />
          <div className="corp-hero__copy">
            <p className="corp-kicker">Tereza Dos Santos</p>
            <h1 id="corp-hero-title">
              Experiences that change
              <br />
              the energy of a room.
            </h1>
            <p className="corp-hero__intro">
              Immersive wellbeing experiences for teams, companies and
              extraordinary gatherings.
            </p>
            <p className="corp-hero__places">
              London · Europe · Middle East · Worldwide
            </p>
            <div className="corp-actions">
              <a className="corp-button" href="#experiences">
                Explore experiences
              </a>
        ...
        <section className="corp-trusted" aria-labelledby="trusted-title">
          <p id="trusted-title" className="corp-kicker">
            Trusted by
          </p>
          <img
            src={images.clients}
            alt="Clients including Forbes, HSBC, Netflix, Disney On Ice, Ferrari, IMAX, Marriott and Emaar"
          />
        </section>

        <section
          id="experiences"
          className="corp-section corp-signatures"
        ...
        >
          <div className="corp-intro">
            ...
            <p>
              From intimate leadership sessions to large-scale immersive
              experiences, each programme is designed around the people, place
        ...
        >
          ...
          <div className="corp-floating__content">
            ...
            <div className="corp-floating__body">
              <p>
                Wireless headphones. Guided meditation. Breathwork. Live sound.
              </p>
              <p>
                A room — or landscape — temporarily transformed into somewhere
                else entirely.
              </p>
            </div>
            <dl>
              ...
              <div>
                <dt>Capacity</dt>
                <dd>Tailored to the event</dd>
              </div>
              <div>
                <dt>Setting</dt>
                <dd>Indoor or outdoor</dd>
              </div>
              <div>
                <dt>Production</dt>
                <dd>Full technical setup available</dd>
              </div>
            </dl>
        ...
        <section
          className="corp-section corp-created"
        ...
        <section className="corp-programmes" aria-labelledby="programmes-title">
          <div className="corp-programmes__intro">
            ...
            <p>
              In person, online or hybrid. As a standalone experience or part of
              a retreat, leadership offsite or company event.
            </p>
          </div>
        ...
        <section className="corp-process" aria-labelledby="process-title">
          <div>
            <p className="corp-kicker">From brief to room</p>
          ...
          <ol>
            ...
            <li>
              <span>02</span>
              <p>We design the experience</p>
            </li>
            <li>
              <span>03</span>
              <p>Tereza + team deliver it</p>
            </li>
          </ol>
        </section>
        ...
        <section className="corp-proof" aria-labelledby="proof-title">
          <div>
            <p className="corp-kicker">Designed to travel</p>
            <h2 id="proof-title">
              One vision.
              <br />
              Every detail.
        ...
        <section className="corp-impact" aria-labelledby="impact-title">
          ...
          <p className="corp-impact__sources">
            Sources: Gallup · Harvard Health Publishing · Stanford Medicine ·
            NIH · WHO
          </p>
        </section>
        ...
        <section className="corp-case" aria-labelledby="case-title">
          ...
          <div className="corp-case__copy">
            ...
            <h2 id="case-title">
              Recovery and resilience on a global production.
            </h2>
            <div className="corp-case__details">
              <article>
                <h3>The challenge</h3>
                <p>
                  Elite performers, cast, crew and management working through
                  demanding schedules, constant travel and limited recovery
                  time.
                </p>
              </article>
              <article>
                ...
                <p>
                  A tailored series of breathwork, recovery, nervous-system
                  regulation and team-connection experiences integrated into
                  tour life.
                </p>
              </article>
              <article>
                <h3>The outcome</h3>
                <p>
                  High participation, positive feedback, improved recovery
                  between performances and expansion of the programme
                  company-wide.
                </p>
              </article>
            </div>
        ...
        <section
          className="corp-section corp-testimonials"
          aria-labelledby="testimonials-title"
        >
          <div className="corp-testimonials__heading">
            <p className="corp-kicker">In their words</p>
            <h2 id="testimonials-title">The ripple effect</h2>
          </div>
        ...
        <section
          id="about"
          className="corp-about"
          aria-labelledby="about-title"
        >
          <div className="corp-about__image">
            <img src={images.portrait} alt="Tereza Dos Santos" loading="lazy" />
          </div>
          <div className="corp-about__copy">
            <p className="corp-kicker">About Tereza</p>
            <h2 id="about-title">
              Presence, performance and the art of gathering.
            </h2>
            <p>
              Tereza Dos Santos is an international facilitator and performance
              specialist with more than two decades of experience creating
              experiences in high-pressure, live environments.
            </p>
            <p>
              Her work brings together breath, movement, sound and human
              connection — delivered with a trusted international network and
              shaped around each organisation, audience and setting.
            </p>
        ...
        >
          <div className="corp-enquiry__intro">
            ...
            <p>
              Tell us a little about your team or event and we'll recommend the
              right experience.
            </p>
            <a href="mailto:corporate@terezadossantos.com">
              corporate@terezadossantos.com
            </a>
          </div>
          <form className="corp-form" onSubmit={handleEnquirySubmit}>
            ...
            <label>
              ...
              <select name="eventType" required defaultValue="">
                ...
                <option>Brand / Hospitality Event</option>
                <option>Other</option>
              </select>
            </label>
            <label>
            ...
            <p className="corp-form__note">
              Submitting opens your email app with the enquiry prepared for you.
            </p>
          </form>
        </section>
      </main>
      ...
      <footer className="corp-footer">
        ...
        <p>London · Europe · Middle East · Worldwide</p>
        <a href="mailto:corporate@terezadossantos.com">Corporate enquiries</a>
      </footer>
    </div>
  );
}
