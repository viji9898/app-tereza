...
const rooms = [
  ...
  },
  {
    ...
    summary: "A romantic glass bungalow suspended at the edge of nature.",
    bed: "King or two twins",
    details: ["Optional third bed", "Outdoor shower", "Private bathtub"],
  },
  {
    id: "poolview",
    booked: { september: false, october: false },
  ...
  },
  {
    ...
    summary: "The most secluded suite, close to the river and jungle sounds.",
    bed: "Two double beds",
    details: ["Private patio", "Outdoor stone tub", "Indoor en suite"],
  },
  {
    id: "family-one",
    booked: { september: false, october: false },
  ...
  },
  {
    ...
    summary: "The most spacious suite, with jungle views and pool access.",
    bed: "Super king bed",
    details: ["Private patio", "Circular bathtub", "Direct pool access"],
  },
  {
    id: "mural",
    booked: { september: false, october: false },
    ...
    summary: "A generous, cooling room with a glowing onyx bathroom.",
    bed: "Two double beds",
    details: ["Private patio", "Outdoor bathtub", "Long writing desk"],
  },
  {
    id: "gardenview",
    booked: { september: false, october: false },
    ...
    summary: "A compact and private suite tucked beside the garden.",
    bed: "King bed",
    details: ["Pool & garden views", "Onyx vanity", "Outdoor bathtub"],
  },
  {
    id: "fishbowl",
    booked: { september: false, october: false },
