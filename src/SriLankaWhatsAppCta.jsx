import "./SriLankaWhatsAppCta.css";

const WHATSAPP_NUMBER = "201010001133";
const WHATSAPP_MESSAGE =
  "Hello Tereza, I would like more information about The RESET Sri Lanka retreat, October 3-9, 2026.";
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(WHATSAPP_MESSAGE)}`;

export default function SriLankaWhatsAppCta() {
  return (
    <section
      className="sri-lanka-whatsapp-cta"
      aria-labelledby="sri-lanka-whatsapp-cta-title"
    >
      <h2
        id="sri-lanka-whatsapp-cta-title"
        className="sri-lanka-whatsapp-cta__title"
      >
        Your Sri Lanka Journey starts here.
      </h2>
      <p className="sri-lanka-whatsapp-cta__copy">
        Message us directly for retreat details, room availability, bookings, or
        any questions you may have.
      </p>
      <a
        className="sri-lanka-whatsapp-cta__link"
        href={WHATSAPP_URL}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Message us about The RESET Sri Lanka retreat on WhatsApp"
      >
        Let’s Go!
        <svg
          className="sri-lanka-whatsapp-cta__icon"
          viewBox="0 0 24 24"
          aria-hidden="true"
        >
          <path
