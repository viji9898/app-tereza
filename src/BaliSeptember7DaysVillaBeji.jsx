...
import "./BaliSeptember7DaysVillaBeji.css";
...
export default function BaliSeptember7DaysVillaBeji() {
  ...
  return (
    <div className="bali-villa-beji-page">
      <div className="kurulu-bay-page">
        ...
        <button
          ...
          aria-controls="bali-september-7-days-villa-beji-contents-menu"
        ...
        <aside
          id="bali-september-7-days-villa-beji-contents-menu"
