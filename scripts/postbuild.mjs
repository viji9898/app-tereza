...
const routeMetadata = {
  ...
  baliOctoberInvestment: {
    routePath: "/bali-october/investment",
  ...
  baliCreativeGetawayFlex: {
    ...
    description:
      "Choose a flexible stay at Dwa Chandra between 3 and 17 October 2026, from $180 USD per night with a six-night minimum.",
    image:
...
for (const [directoryName, metadata] of [
  ...
  ["bali-october/investment", routeMetadata.baliOctoberInvestment],
